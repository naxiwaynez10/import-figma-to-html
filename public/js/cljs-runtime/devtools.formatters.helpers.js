...
var G__41403 = devtools.prefs.pref(v);
v = G__41403;
continue;
} else {
return v;
...
}catch (e41392){var _e__38661__auto__ = e41392;
return false;
}})();
...
}catch (e41394){var _e__38661__auto__ = e41394;
return false;
}})();
...
}catch (e41396){var _e__38661__auto__ = e41396;
return false;
}}
}
});
...
var vec__41398 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41398,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41398,(1),null);
...
return cljs.core.some((function (p1__41401_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41401_SHARP_);
}),template);
});
