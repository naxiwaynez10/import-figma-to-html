...
var len__5769__auto___40948 = arguments.length;
var i__5770__auto___40949 = (0);
while(true){
if((i__5770__auto___40949 < len__5769__auto___40948)){
args__5775__auto__.push((arguments[i__5770__auto___40949]));

var G__40950 = (i__5770__auto___40949 + (1));
i__5770__auto___40949 = G__40950;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__40867_40951 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__40868_40952 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__40869_40953 = true;
var _STAR_print_fn_STAR__temp_val__40870_40954 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__40869_40953);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__40870_40954);

try{var _STAR_print_level_STAR__orig_val__40871_40955 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__40872_40956 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__40872_40956);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__40871_40955);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__40868_40952);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__40867_40951);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq40866){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq40866));
}));
...
var new_formatters = current_formatters.filter((function (p1__40874_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__40874_SHARP_)));
}));
...
var G__40875_40962 = f;
var target__38657__auto___40963 = G__40875_40962;
if(cljs.core.truth_(target__38657__auto___40963)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40875_40962)].join(''),"\n","target__38657__auto__"].join('')));
}

(target__38657__auto___40963["toString"] = (function (){
...
var G__40876_40964 = "%c%s";
var G__40877_40965 = "color:transparent";
var G__40878_40966 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__40876_40964,G__40877_40965,G__40878_40966) : f.call(null,G__40876_40964,G__40877_40965,G__40878_40966));
...
var args__5775__auto__ = [];
var len__5769__auto___41030 = arguments.length;
var i__5770__auto___41031 = (0);
while(true){
if((i__5770__auto___41031 < len__5769__auto___41030)){
args__5775__auto__.push((arguments[i__5770__auto___41031]));

var G__41032 = (i__5770__auto___41031 + (1));
i__5770__auto___41031 = G__41032;
continue;
} else {
}
break;
...
var vec__40883 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40883,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40883,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__41034__delegate = function (add_fmt,add_args){
...
var G__41034 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__41035__i = 0, G__41035__a = new Array(arguments.length -  1);
while (G__41035__i < G__41035__a.length) {G__41035__a[G__41035__i] = arguments[G__41035__i + 1]; ++G__41035__i;}
  add_args = new cljs.core.IndexedSeq(G__41035__a,0,null);
} 
return G__41034__delegate.call(this,add_fmt,add_args);};
G__41034.cljs$lang$maxFixedArity = 1;
G__41034.cljs$lang$applyTo = (function (arglist__41036){
var add_fmt = cljs.core.first(arglist__41036);
var add_args = cljs.core.rest(arglist__41036);
return G__41034__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq40879){
...
var G__40882 = cljs.core.first(seq40879__$2);
var seq40879__$3 = cljs.core.next(seq40879__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40880,G__40881,G__40882,seq40879__$3);
}));
...
var seq__40886 = cljs.core.seq(features);
var chunk__40887 = null;
var count__40888 = (0);
var i__40889 = (0);
while(true){
if((i__40889 < count__40888)){
var feature = chunk__40887.cljs$core$IIndexed$_nth$arity$2(null,i__40889);
...
var G__41038 = seq__40886;
var G__41039 = chunk__40887;
var G__41040 = count__40888;
var G__41041 = (i__40889 + (1));
seq__40886 = G__41038;
chunk__40887 = G__41039;
count__40888 = G__41040;
i__40889 = G__41041;
continue;
} else {
...
var G__41042 = cljs.core.chunk_rest(seq__40886__$1);
var G__41043 = c__5568__auto__;
var G__41044 = cljs.core.count(c__5568__auto__);
var G__41045 = (0);
seq__40886 = G__41042;
chunk__40887 = G__41043;
count__40888 = G__41044;
i__40889 = G__41045;
continue;
} else {
var feature = cljs.core.first(seq__40886__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__41046 = cljs.core.next(seq__40886__$1);
var G__41047 = null;
var G__41048 = (0);
var G__41049 = (0);
seq__40886 = G__41046;
chunk__40887 = G__41047;
count__40888 = G__41048;
i__40889 = G__41049;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o40891 = temp__5802__auto__;
return (o40891["version"]);
} else {
return null;
}
})() == null);
