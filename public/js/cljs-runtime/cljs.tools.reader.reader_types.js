...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_42197 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_42197(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_42198 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_42198(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42199 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42199(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42205 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42205(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42206 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42206(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42207 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42207(reader);
}
});
...
var G__42228 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__42229 = s.append(c);
c = G__42228;
s = G__42229;
continue;
}
