...
var len__5769__auto___41754 = arguments.length;
var i__5770__auto___41755 = (0);
while(true){
if((i__5770__auto___41755 < len__5769__auto___41754)){
args__5775__auto__.push((arguments[i__5770__auto___41755]));

var G__41756 = (i__5770__auto___41755 + (1));
i__5770__auto___41755 = G__41756;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41617){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41618,G__41619,seq41617__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41686_SHARP_){
return (!((cljs.core.meta(p1__41686_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41716__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41717){var _e__38661__auto__ = e41717;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e41737){var _e__38661__auto__ = e41737;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41739 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41740 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41740);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41741__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41739);
}});
...
var temp__5802__auto___41757 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___41757)){
var managed_print_level_41758 = temp__5802__auto___41757;
var _STAR_print_level_STAR__orig_val__41743_41759 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41744_41760 = managed_print_level_41758;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41744_41760);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41742_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41742_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41743_41759);
}} else {
job_fn();
}
