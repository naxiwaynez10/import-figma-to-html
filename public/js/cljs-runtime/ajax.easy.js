...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__50942 = cljs.core.second(format);
var G__50943 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__50942,G__50943) : ajax.easy.keyword_response_format_element.call(null,G__50942,G__50943));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50945_SHARP_){
return ajax.easy.keyword_response_format_element(p1__50945_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__50952){
...
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50953__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50953__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__50954){
var vec__50955 = p__50954;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50955,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50955,(1),null);
var fexpr__50958_50976 = (cljs.core.truth_(ok)?h:e);
(fexpr__50958_50976.cljs$core$IFn$_invoke$arity$1 ? fexpr__50958_50976.cljs$core$IFn$_invoke$arity$1(result) : fexpr__50958_50976.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__50959){
var map__50960 = p__50959;
var map__50960__$1 = cljs.core.__destructure_map(map__50960);
var opts = map__50960__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50960__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50960__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50960__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50960__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50960__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
