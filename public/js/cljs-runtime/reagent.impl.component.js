...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__49864 = c;
var G__49864__$1 = (((G__49864 == null))?null:G__49864.prototype);
if((G__49864__$1 == null)){
return null;
} else {
return G__49864__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__49865 = c;
var G__49865__$1 = (((G__49865 == null))?null:G__49865.prototype);
if((G__49865__$1 == null)){
return null;
} else {
return G__49865__$1.render;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__49867 = c;
var G__49867__$1 = (((G__49867 == null))?null:G__49867.constructor);
if((G__49867__$1 == null)){
return null;
} else {
return G__49867__$1.displayName;
}
})();
...
var G__49868 = c;
var G__49868__$1 = (((G__49868 == null))?null:G__49868.constructor);
if((G__49868__$1 == null)){
return null;
} else {
return G__49868__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__49869 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__49870 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__49870);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__49869);
}});
...
var c = this;
var G__49879_49973 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__49879_49973 == null)){
} else {
reagent.ratom.dispose_BANG_(G__49879_49973);
}
...
var renders_49975 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_49976 = cljs.core.first(cljs.core.vals(renders_49975));
...
if((cljs.core.count(renders_49975) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_49975))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_49976)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_49976], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__49880 = o;
reagent.impl.component.goog$module$goog$object.set(G__49880,cljs.core.name(k),v);
...
G__49978.cljs$lang$applyTo = (function (arglist__49980){
...
var _STAR_current_component_STAR__orig_val__49923 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__49924 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__49924);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__49923);
}});
...
var vec__49946 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49946,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49946,(1),null);
...
var G__49949 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__49949 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__49949);
}
});
}),[]);
