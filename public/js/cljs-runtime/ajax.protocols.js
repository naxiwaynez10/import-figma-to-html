...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_50671 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_50671(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_50672 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_50672(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_50673 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_50673(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_50767 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_50767(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_50768 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_50768(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_50771 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_50771(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_50772 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_50772(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_50773 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_50773(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_50774 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_50774(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_50775 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_50775(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k50582,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k50582,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__50589){
var vec__50590 = p__50589;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50590,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50590,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__50581){
var self__ = this;
var G__50581__$1 = this;
return (new cljs.core.RecordIter((0),G__50581__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this50583,other50584){
var self__ = this;
var this50583__$1 = this;
return (((!((other50584 == null)))) && ((((this50583__$1.constructor === other50584.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50583__$1.status,other50584.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50583__$1.body,other50584.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50583__$1.status_text,other50584.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50583__$1.headers,other50584.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50583__$1.was_aborted,other50584.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50583__$1.__extmap,other50584.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k50582){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k50582);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__50581){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__50658 = cljs.core.keyword_identical_QMARK_;
var expr__50659 = k__5352__auto__;
if(cljs.core.truth_((pred__50658.cljs$core$IFn$_invoke$arity$2 ? pred__50658.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__50659) : pred__50658.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__50659)))){
return (new ajax.protocols.Response(G__50581,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50658.cljs$core$IFn$_invoke$arity$2 ? pred__50658.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__50659) : pred__50658.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__50659)))){
return (new ajax.protocols.Response(self__.status,G__50581,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50658.cljs$core$IFn$_invoke$arity$2 ? pred__50658.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__50659) : pred__50658.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__50659)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__50581,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50658.cljs$core$IFn$_invoke$arity$2 ? pred__50658.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__50659) : pred__50658.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__50659)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__50581,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50658.cljs$core$IFn$_invoke$arity$2 ? pred__50658.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__50659) : pred__50658.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__50659)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__50581,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__50581),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__50581){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__50581,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__50585){
var extmap__5385__auto__ = (function (){var G__50668 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__50585,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__50585)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__50668);
} else {
return G__50668;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__50585),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__50585),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__50585),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__50585),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__50585),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
