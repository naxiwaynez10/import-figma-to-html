...
var G__50914 = request;
var G__50915 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__50914,G__50915) : ajax.formats.get_format.call(null,G__50914,G__50915));
} else {
...
return cljs.core.some((function (p1__50917_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__50917_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__50921){
var map__50922 = p__50921;
var map__50922__$1 = cljs.core.__destructure_map(map__50922);
var request = map__50922__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50922__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__50923 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__50923.cljs$core$IFn$_invoke$arity$1 ? fexpr__50923.cljs$core$IFn$_invoke$arity$1(response) : fexpr__50923.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__50925){
var map__50926 = p__50925;
var map__50926__$1 = cljs.core.__destructure_map(map__50926);
var request = map__50926__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50926__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__50924_SHARP_){
return ajax.formats.get_accept_entries(request,p1__50924_SHARP_);
