...
var o41111 = temp__5802__auto__;
var temp__5802__auto____$1 = (o41111["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o41112 = temp__5802__auto____$1;
return (o41112["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38652__auto__ = f;
return (o__38652__auto__["toString"]).call(o__38652__auto__);
} else {
return "";
}
}catch (e41115){var _ = e41115;
return "";
}});
...
try{var o__38652__auto___41404 = t;
(o__38652__auto___41404["cljs$lang$ctorPrWriter"]).call(o__38652__auto___41404,t,writer);
}catch (e41119){var __41405 = e41119;
}
...
var char_code = (function (){var o__38652__auto__ = (new String(char$));
return (o__38652__auto__["charCodeAt"]).call(o__38652__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38652__auto__ = String;
return (o__38652__auto__["fromCharCode"]).call(o__38652__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41132 = num_code;
switch (G__41132) {
case (1):
return (185);
...
var o__38652__auto__ = String;
return (o__38652__auto__["fromCharCode"]).call(o__38652__auto__,superscript_code);
});
/**
...
}catch (e41136){var _e__38661__auto__ = e41136;
return false;
}})())){
...
var vec__41137 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41137,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41145){
var vec__41146 = p__41145;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41146,(0),null);
...
var G__41410 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41411 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41410;
remaining_tokens = G__41411;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41143){
var G__41144 = cljs.core.first(seq41143);
var seq41143__$1 = cljs.core.next(seq41143);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41144,seq41143__$1);
}));
...
var vec__41161 = cljs.core.split_with((function (p1__41159_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41159_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41161,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41161,(1),null);
...
var G__41413 = cljs.core.rest(remaining_tokens);
var G__41414 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__41413;
name_tokens = G__41414;
continue;
} else {
...
var vec__41200 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41200,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41200,(1),null);
var vec__41203 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41203,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41203,(1),null);
var vec__41206 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41206,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41206,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41206,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41206,(3),null);
...
var vec__41228 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41228,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41228,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41228,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41228,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41228,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41228,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__41231 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41231,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41231,(1),null);
var vec__41259 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41259,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41259,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41262 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41262) : devtools.munging.parse_fn_info_deep.call(null,G__41262));
})()));
}
} else {
return fn_info;
...
var G__41440 = (arity + (1));
var G__41441 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41279){
var vec__41281 = p__41279;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41281,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41281,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41291_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41291_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41292_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41292_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___41442 = arguments.length;
var i__5770__auto___41443 = (0);
while(true){
if((i__5770__auto___41443 < len__5769__auto___41442)){
args__5775__auto__.push((arguments[i__5770__auto___41443]));

var G__41444 = (i__5770__auto___41443 + (1));
i__5770__auto___41443 = G__41444;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41295){
var vec__41296 = p__41295;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41296,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41293){
var G__41294 = cljs.core.first(seq41293);
var seq41293__$1 = cljs.core.next(seq41293);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41294,seq41293__$1);
}));
...
var map__41308 = options;
var map__41308__$1 = cljs.core.__destructure_map(map__41308);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41308__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41308__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41308__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41308__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41309 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41309,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41309,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41309,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41309,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41309,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41309,(5),null);
...
var o__38652__auto__ = f;
return (o__38652__auto__["getBasis"]).call(o__38652__auto__);
});
/**
...
}catch (e41312){var _e__38661__auto__ = e41312;
...
var G__41459 = (obj[cljs.core.first(path)]);
var G__41460 = cljs.core.rest(path);
obj = G__41459;
path = G__41460;
continue;
} else {
...
var _STAR_ = (function (accum,p__41340){
var vec__41341 = p__41340;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41341,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41341,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41344){
var vec__41345 = p__41344;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41345,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41345,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41345,(2),null);
...
var post_process = (function (p__41387){
var vec__41388 = p__41387;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41388,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41388,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41386_SHARP_){
return (obj[cljs.core.first(p1__41386_SHARP_)]);
}),sorted_matches);
