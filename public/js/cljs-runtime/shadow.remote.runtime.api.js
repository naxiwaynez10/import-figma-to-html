...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_46925 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_46925(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_46980 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_46980(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_46981 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_46981(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_46986 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_46986(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_46987 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_46987(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_46992 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_46992(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__46923,callback){
var map__46924 = p__46923;
var map__46924__$1 = cljs.core.__destructure_map(map__46924);
var input = map__46924__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46924__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46924__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
