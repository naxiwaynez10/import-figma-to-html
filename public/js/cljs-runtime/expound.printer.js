...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52404_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__52404_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52405_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52405_SHARP_)));
}),row));
});
...
var G__52406 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__52407 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__52406,G__52407) : expound.printer.format.call(null,G__52406,G__52407));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52408_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52408_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52409_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52409_SHARP_)).length),"="));
}),header);
...
var iter__5523__auto__ = (function expound$printer$multirow_$_iter__52410(s__52411){
return (new cljs.core.LazySeq(null,(function (){
var s__52411__$1 = s__52411;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__52411__$1);
if(temp__5804__auto__){
var s__52411__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__52411__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__52411__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__52413 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__52412 = (0);
while(true){
if((i__52412 < size__5522__auto__)){
var row_idx = cljs.core._nth(c__5521__auto__,i__52412);
cljs.core.chunk_append(b__52413,(function (){var iter__5523__auto__ = ((function (i__52412,row_idx,c__5521__auto__,size__5522__auto__,b__52413,s__52411__$2,temp__5804__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__52410_$_iter__52414(s__52415){
return (new cljs.core.LazySeq(null,((function (i__52412,row_idx,c__5521__auto__,size__5522__auto__,b__52413,s__52411__$2,temp__5804__auto__,split_row_contents){
return (function (){
var s__52415__$1 = s__52415;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__52415__$1);
if(temp__5804__auto____$1){
var s__52415__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__52415__$2)){
var c__5521__auto____$1 = cljs.core.chunk_first(s__52415__$2);
var size__5522__auto____$1 = cljs.core.count(c__5521__auto____$1);
var b__52417 = cljs.core.chunk_buffer(size__5522__auto____$1);
if((function (){var i__52416 = (0);
while(true){
if((i__52416 < size__5522__auto____$1)){
var col_idx = cljs.core._nth(c__5521__auto____$1,i__52416);
cljs.core.chunk_append(b__52417,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__52493 = (i__52416 + (1));
i__52416 = G__52493;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52417),expound$printer$multirow_$_iter__52410_$_iter__52414(cljs.core.chunk_rest(s__52415__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52417),null);
}
} else {
var col_idx = cljs.core.first(s__52415__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__52410_$_iter__52414(cljs.core.rest(s__52415__$2)));
}
} else {
return null;
}
...
});})(i__52412,row_idx,c__5521__auto__,size__5522__auto__,b__52413,s__52411__$2,temp__5804__auto__,split_row_contents))
,null,null));
});})(i__52412,row_idx,c__5521__auto__,size__5522__auto__,b__52413,s__52411__$2,temp__5804__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52413),expound$printer$multirow_$_iter__52410(cljs.core.chunk_rest(s__52411__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52413),null);
}
} else {
var row_idx = cljs.core.first(s__52411__$2);
return cljs.core.cons((function (){var iter__5523__auto__ = ((function (row_idx,s__52411__$2,temp__5804__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__52410_$_iter__52418(s__52419){
return (new cljs.core.LazySeq(null,(function (){
var s__52419__$1 = s__52419;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__52419__$1);
if(temp__5804__auto____$1){
var s__52419__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__52419__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__52419__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__52421 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__52420 = (0);
while(true){
if((i__52420 < size__5522__auto__)){
var col_idx = cljs.core._nth(c__5521__auto__,i__52420);
cljs.core.chunk_append(b__52421,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__52496 = (i__52420 + (1));
i__52420 = G__52496;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52421),expound$printer$multirow_$_iter__52410_$_iter__52418(cljs.core.chunk_rest(s__52419__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52421),null);
}
} else {
var col_idx = cljs.core.first(s__52419__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__52410_$_iter__52418(cljs.core.rest(s__52419__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__52411__$2,temp__5804__auto__,split_row_contents))
;
return iter__5523__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__52410(cljs.core.rest(s__52411__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52422_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__52422_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__52429 = via;
var G__52429__$1 = (((G__52429 == null))?null:cljs.core.last(G__52429));
if((G__52429__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__52429__$1);
}
})();
var keys_specs = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__52427_SHARP_){
return cljs.spec.alpha.valid_QMARK_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__52427_SHARP_);
...
}),cljs.core.tree_seq(cljs.core.coll_QMARK_,cljs.core.seq,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"clauses","clauses",1454841241),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52428_SHARP_){
return cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__52428_SHARP_);
}),keys_specs)], 0))], 0))))));
}
});
expound.printer.key__GT_spec = (function expound$printer$key__GT_spec(keys,problems){
var seq__52431_52499 = cljs.core.seq(problems);
var chunk__52432_52500 = null;
var count__52433_52501 = (0);
var i__52434_52502 = (0);
while(true){
if((i__52434_52502 < count__52433_52501)){
var p_52505 = chunk__52432_52500.cljs$core$IIndexed$_nth$arity$2(null,i__52434_52502);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_52505) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__52506 = seq__52431_52499;
var G__52507 = chunk__52432_52500;
var G__52508 = count__52433_52501;
var G__52509 = (i__52434_52502 + (1));
seq__52431_52499 = G__52506;
chunk__52432_52500 = G__52507;
count__52433_52501 = G__52508;
i__52434_52502 = G__52509;
continue;
} else {
var temp__5804__auto___52510 = cljs.core.seq(seq__52431_52499);
if(temp__5804__auto___52510){
var seq__52431_52511__$1 = temp__5804__auto___52510;
if(cljs.core.chunked_seq_QMARK_(seq__52431_52511__$1)){
var c__5568__auto___52512 = cljs.core.chunk_first(seq__52431_52511__$1);
var G__52513 = cljs.core.chunk_rest(seq__52431_52511__$1);
var G__52514 = c__5568__auto___52512;
var G__52515 = cljs.core.count(c__5568__auto___52512);
var G__52516 = (0);
seq__52431_52499 = G__52513;
chunk__52432_52500 = G__52514;
count__52433_52501 = G__52515;
i__52434_52502 = G__52516;
continue;
} else {
var p_52517 = cljs.core.first(seq__52431_52511__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_52517) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__52518 = cljs.core.next(seq__52431_52511__$1);
var G__52519 = null;
var G__52520 = (0);
var G__52521 = (0);
seq__52431_52499 = G__52518;
chunk__52432_52500 = G__52519;
count__52433_52501 = G__52520;
i__52434_52502 = G__52521;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__5045__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__52430_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__52430_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__52435){
var vec__52436 = p__52435;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52436,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52436,(1),null);
var G__52439 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52439__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__52440 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52440,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52440,(1),null);
var G__52443 = branch;
var G__52443__$1 = (((G__52443 instanceof cljs.core.Keyword))?G__52443.fqn:null);
switch (G__52443__$1) {
case "simple":
return new cljs.core.Keyword(null,"kw","kw",1158308175).cljs$core$IFn$_invoke$arity$1(match);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52443__$1)].join('')));
...
var len__5769__auto___52526 = arguments.length;
var i__5770__auto___52527 = (0);
while(true){
if((i__5770__auto___52527 < len__5769__auto___52526)){
args__5775__auto__.push((arguments[i__5770__auto___52527]));

var G__52528 = (i__5770__auto___52527 + (1));
i__5770__auto___52527 = G__52528;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq52444){
var G__52445 = cljs.core.first(seq52444);
var seq52444__$1 = cljs.core.next(seq52444);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52445,seq52444__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52446_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__52446_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__52447_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__52447_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__52448){
var vec__52449 = p__52448;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52449,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52449,(1),null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52452_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__52452_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__52456 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
...
var line = first__52458;
var lines = seq__52457__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52453_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52453_SHARP_)].join('');
}),lines)));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__52462 = show_valid_values_QMARK_;
var G__52463 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__52464 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__52462,G__52463,G__52464) : expound.printer.summary_form.call(null,G__52462,G__52463,G__52464));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__52551 = show_valid_values_QMARK_;
var G__52552 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__52553 = rst__$1;
show_valid_values_QMARK_ = G__52551;
form = G__52552;
in$ = G__52553;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__52465 = show_valid_values_QMARK_;
var G__52466 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__52467 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__52465,G__52466,G__52467) : expound.printer.summary_form.call(null,G__52465,G__52466,G__52467));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__52468 = show_valid_values_QMARK_;
var G__52469 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__52470 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__52468,G__52469,G__52470) : expound.printer.summary_form.call(null,G__52468,G__52469,G__52470));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__52471 = show_valid_values_QMARK_;
var G__52472 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__52473 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__52471,G__52472,G__52473) : expound.printer.summary_form.call(null,G__52471,G__52472,G__52473));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__52474 = show_valid_values_QMARK_;
var G__52475 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__52476 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__52474,G__52475,G__52476) : expound.printer.summary_form.call(null,G__52474,G__52475,G__52476));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52477_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52477_SHARP_)).length);
...
var map__52478 = problem;
var map__52478__$1 = cljs.core.__destructure_map(map__52478);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52478__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52478__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__52479 = opts;
var map__52479__$1 = cljs.core.__destructure_map(map__52479);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52479__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__52483 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__52484 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__52484);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__52483);
}})();
var vec__52480 = cljs.core.re_find(regex,s);
var seq__52481 = cljs.core.seq(vec__52480);
var first__52482 = cljs.core.first(seq__52481);
var seq__52481__$1 = cljs.core.next(seq__52481);
var line = first__52482;
var first__52482__$1 = cljs.core.first(seq__52481__$1);
var seq__52481__$2 = cljs.core.next(seq__52481__$1);
var prefix = first__52482__$1;
var _more = seq__52481__$2;
